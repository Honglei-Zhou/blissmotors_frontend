  ...
  <div class="model-container">
    ...
    <div class="content-row">
      ...
      <div class="content-right">
        ...
        <div class="filter-button"><i-button @click.stop.prevent="filterCar">Apply</i-button></div>
        </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    selectItem (item) {
      // console.log(item)
      this.$router.push({
        path: `/research/style/${this.$route.params.style}/${item.make}/${item.model}`
      })
    },
    reloadPage (pagesize) {
    ...
    _getCarStyle () {
      var style = this.$route.params.style
      ...
      carService.getCarByStyle(style, current, pageSize, msrpMin, msrpMax, paymentMin, paymentMax).then((resp) => {
